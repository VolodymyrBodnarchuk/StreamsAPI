...
import main.java.com.bobocode.data.Account;
import main.java.com.bobocode.fp.exception.EntityNotFoundException;
...
public class CrazyStreams {
    ...
    public Map<String, Set<String>> groupFirstNamesByLastNames() {
        return accounts.stream()
                .collect(groupingBy(Account::getLastName, mapping(Account::getFirstName,Collectors.toSet())));
    }
